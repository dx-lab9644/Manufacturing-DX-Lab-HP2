          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <p className="text-center text-sm font-medium text-gray-600 mb-2">ダッシュボード</p>
                <Image src="/assets/alisa_dashboard.png" alt="ALISAダッシュボード" width={800} height={500} className="w-full object-cover" />
              </div>
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <p className="text-center text-sm font-medium text-gray-600 mb-2">MRP実行</p>
                <Image src="/assets/alisa_mrp.png" alt="ALISA MRP実行" width={800} height={500} className="w-full object-cover" />
              </div>
            </div>
          </div>
        </div>
